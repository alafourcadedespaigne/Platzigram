...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(py.puchi.platzigram.R.layout.fragment_home, container, false);
        showToolbar(getResources().getString(py.puchi.platzigram.R.string.tab_home), false, view);
        RecyclerView picturesRecycler = (RecyclerView) view.findViewById(py.puchi.platzigram.R.id.pictureRecycler);
